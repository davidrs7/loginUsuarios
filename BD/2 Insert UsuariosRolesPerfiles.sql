...
INSERT INTO Cargos (Nombre, Descripcion, EmpresaID, Estado) VALUES
    ('Gerente General', 'Gerente General de la Empresa A', 1, 1),
...
INSERT INTO Usuarios (Nombre, TipoDocumento, NumDocumento, CorreoElectronico, Contraseña, Telefono, Direccion, FechaNacimiento, FechaCreacion, SexoId, JefeId, RolID, CargoID, EmpresaID, UsuarioIdOpcional, Estado) VALUES
    ('Admin Usuario', 1, '123456789', 'admin@example.com', 'admin123', '1234567890', 'Calle Principal 123', '1990-01-01', NOW(), 1, NULL, 1, NULL, 1, NULL, 1),
...
-- Insertar datos de ejemplo en Sesiones (Para propósitos de ejemplo)
INSERT INTO Sesiones (UsuarioID, Token, FechaInicio, FechaFin, Estado) VALUES
    (1, 'token_admin_123', NOW(), NULL, 1),
    (2, 'token_user1_456', NOW(), NULL, 1);

-- Insertar datos de ejemplo en 
